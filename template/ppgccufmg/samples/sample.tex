...
\documentclass[msc,proposal,hidelof,hidelot]{ppgccufmg}  % [phd] se for doutorado
...
\ppgccufmg{
  title={Watershed: Remodelando a interface de \emph{streams}},
  authorrev={Rocha, Rodrigo Caetano de Oliveira},
